/**
 *  \file src/MBCSR/MatTrisolve/7x1.c
 *  \brief The \f$7\times 1\f$ MBCSR implementation
 *  of sparse triangular solve.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_trisolve.sh
 *  on Wed Jun  8 16:08:39 PDT 2005.
 */
...
#include <oski/MBCSR/module.h>
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 7, dp += 7*7 )
	{
		...
		const oski_value_t* vp = val + ptr[I-1]*7*1;
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*1 )
		{
			...
			VAL_MSUB( _b1, vp[1], _x0 );
			VAL_MSUB( _b2, vp[2], _x0 );
			VAL_MSUB( _b3, vp[3], _x0 );
			VAL_MSUB( _b4, vp[4], _x0 );
			VAL_MSUB( _b5, vp[5], _x0 );
			VAL_MSUB( _b6, vp[6], _x0 );
		} /* K */
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xsX_7x1)
#endif
...
/**
 *  \brief Exported module wrapper for the \f$7\times 1\f$
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 7, dp += 7*7 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*1 )
		{
			...
			VAL_MSUB_CONJ( _b1, vp[1], _x0 );
			VAL_MSUB_CONJ( _b2, vp[2], _x0 );
			VAL_MSUB_CONJ( _b3, vp[3], _x0 );
			VAL_MSUB_CONJ( _b4, vp[4], _x0 );
			VAL_MSUB_CONJ( _b5, vp[5], _x0 );
			VAL_MSUB_CONJ( _b6, vp[6], _x0 );
		} /* K */
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xsX_7x1)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 7, dp -= 7*7 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*1 )
		{
			...
			VAL_MSUB( _x0, vp[1], _b1 );
			VAL_MSUB( _x0, vp[2], _b2 );
			VAL_MSUB( _x0, vp[3], _b3 );
			VAL_MSUB( _x0, vp[4], _b4 );
			VAL_MSUB( _x0, vp[5], _b5 );
			VAL_MSUB( _x0, vp[6], _b6 );
			VAL_ASSIGN( xp[0], _x0 );
		} /* K */
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xsX_7x1)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 7, dp -= 7*7 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*1 )
		{
			...
			VAL_MSUB_CONJ( _x0, vp[1], _b1 );
			VAL_MSUB_CONJ( _x0, vp[2], _b2 );
			VAL_MSUB_CONJ( _x0, vp[3], _b3 );
			VAL_MSUB_CONJ( _x0, vp[4], _b4 );
			VAL_MSUB_CONJ( _x0, vp[5], _b5 );
			VAL_MSUB_CONJ( _x0, vp[6], _b6 );
			VAL_ASSIGN( xp[0], _x0 );
		} /* K */
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xsX_7x1)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xsX_7x1)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xsX_7x1)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xsX_7x1)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xs1_7x1)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xsX_7x1)
#endif
...
#define SubmatReprTrisolve MANGLE_MOD_(SubmatReprTrisolve_7x1)
#endif

/**
 *  \brief Entry point to the 7x1 kernel that implements
