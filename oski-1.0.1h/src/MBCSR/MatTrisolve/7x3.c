/**
 *  \file src/MBCSR/MatTrisolve/7x3.c
 ...
 *  on Wed Jun  8 16:08:51 PDT 2005.
 */
...
#include <oski/MBCSR/module.h>
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 7, dp += 7*7 )
	{
		...
		const oski_value_t* vp = val + ptr[I-1]*7*3;
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*3 )
		{
			...
			VAL_MSUB( _b2, vp[6], _x0 );
			VAL_MSUB( _b3, vp[9], _x0 );
			VAL_MSUB( _b4, vp[12], _x0 );
			VAL_MSUB( _b5, vp[15], _x0 );
			VAL_MSUB( _b6, vp[18], _x0 );
			VAL_MSUB( _b0, vp[1], _x1 );
			VAL_MSUB( _b1, vp[4], _x1 );
			VAL_MSUB( _b2, vp[7], _x1 );
			VAL_MSUB( _b3, vp[10], _x1 );
			VAL_MSUB( _b4, vp[13], _x1 );
			VAL_MSUB( _b5, vp[16], _x1 );
			VAL_MSUB( _b6, vp[19], _x1 );
			VAL_MSUB( _b0, vp[2], _x2 );
			VAL_MSUB( _b1, vp[5], _x2 );
			VAL_MSUB( _b2, vp[8], _x2 );
			VAL_MSUB( _b3, vp[11], _x2 );
			VAL_MSUB( _b4, vp[14], _x2 );
			VAL_MSUB( _b5, vp[17], _x2 );
			VAL_MSUB( _b6, vp[20], _x2 );
		} /* K */
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xsX_7x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 7, dp += 7*7 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*3 )
		{
			...
			VAL_MSUB_CONJ( _b2, vp[6], _x0 );
			VAL_MSUB_CONJ( _b3, vp[9], _x0 );
			VAL_MSUB_CONJ( _b4, vp[12], _x0 );
			VAL_MSUB_CONJ( _b5, vp[15], _x0 );
			VAL_MSUB_CONJ( _b6, vp[18], _x0 );
			VAL_MSUB_CONJ( _b0, vp[1], _x1 );
			VAL_MSUB_CONJ( _b1, vp[4], _x1 );
			VAL_MSUB_CONJ( _b2, vp[7], _x1 );
			VAL_MSUB_CONJ( _b3, vp[10], _x1 );
			VAL_MSUB_CONJ( _b4, vp[13], _x1 );
			VAL_MSUB_CONJ( _b5, vp[16], _x1 );
			VAL_MSUB_CONJ( _b6, vp[19], _x1 );
			VAL_MSUB_CONJ( _b0, vp[2], _x2 );
			VAL_MSUB_CONJ( _b1, vp[5], _x2 );
			VAL_MSUB_CONJ( _b2, vp[8], _x2 );
			VAL_MSUB_CONJ( _b3, vp[11], _x2 );
			VAL_MSUB_CONJ( _b4, vp[14], _x2 );
			VAL_MSUB_CONJ( _b5, vp[17], _x2 );
			VAL_MSUB_CONJ( _b6, vp[20], _x2 );
		} /* K */
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xsX_7x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 7, dp -= 7*7 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*3 )
		{
			...
			VAL_MSUB( _x0, vp[6], _b2 );
			VAL_MSUB( _x1, vp[7], _b2 );
			VAL_MSUB( _x2, vp[8], _b2 );
			VAL_MSUB( _x0, vp[9], _b3 );
			VAL_MSUB( _x1, vp[10], _b3 );
			VAL_MSUB( _x2, vp[11], _b3 );
			VAL_MSUB( _x0, vp[12], _b4 );
			VAL_MSUB( _x1, vp[13], _b4 );
			VAL_MSUB( _x2, vp[14], _b4 );
			VAL_MSUB( _x0, vp[15], _b5 );
			VAL_MSUB( _x1, vp[16], _b5 );
			VAL_MSUB( _x2, vp[17], _b5 );
			VAL_MSUB( _x0, vp[18], _b6 );
			VAL_MSUB( _x1, vp[19], _b6 );
			VAL_MSUB( _x2, vp[20], _b6 );
			VAL_ASSIGN( xp[0], _x0 );
			VAL_ASSIGN( xp[1], _x1 );
			VAL_ASSIGN( xp[2], _x2 );
		} /* K */
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xsX_7x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 7, dp -= 7*7 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 7*3 )
		{
			...
			VAL_MSUB_CONJ( _x0, vp[6], _b2 );
			VAL_MSUB_CONJ( _x1, vp[7], _b2 );
			VAL_MSUB_CONJ( _x2, vp[8], _b2 );
			VAL_MSUB_CONJ( _x0, vp[9], _b3 );
			VAL_MSUB_CONJ( _x1, vp[10], _b3 );
			VAL_MSUB_CONJ( _x2, vp[11], _b3 );
			VAL_MSUB_CONJ( _x0, vp[12], _b4 );
			VAL_MSUB_CONJ( _x1, vp[13], _b4 );
			VAL_MSUB_CONJ( _x2, vp[14], _b4 );
			VAL_MSUB_CONJ( _x0, vp[15], _b5 );
			VAL_MSUB_CONJ( _x1, vp[16], _b5 );
			VAL_MSUB_CONJ( _x2, vp[17], _b5 );
			VAL_MSUB_CONJ( _x0, vp[18], _b6 );
			VAL_MSUB_CONJ( _x1, vp[19], _b6 );
			VAL_MSUB_CONJ( _x2, vp[20], _b6 );
			VAL_ASSIGN( xp[0], _x0 );
			VAL_ASSIGN( xp[1], _x1 );
			VAL_ASSIGN( xp[2], _x2 );
		} /* K */
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xsX_7x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xsX_7x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xsX_7x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xsX_7x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xs1_7x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xsX_7x3)
#endif
...
#define SubmatReprTrisolve MANGLE_MOD_(SubmatReprTrisolve_7x3)
#endif
