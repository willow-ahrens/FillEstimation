/**
 *  \file src/MBCSR/MatMultAndMatTransMult/2x8.c
 *  \brief The \f$2\times 8\f$ MBCSR implementation
 *  of simultaneous multiplication by \f$A\f$ and \f$\mathrm{op}(A)\f$.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_a_and_at.sh on Wed Jun  8 15:53:58 PDT 2005.
 */
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_2x8)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 2*incy, zp += 2*incz, diag += 2*2 )
	{
		oski_index_t K;
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 2*8 )
		{
		...
		/* Diag block multiply */
		{
			...
			REGISTER oski_value_t _x0;
			REGISTER oski_value_t _x1;
			const oski_value_t* wp = w + (d0 + I*2);
			REGISTER oski_value_t _w0;
			REGISTER oski_value_t _w1;
			...
			VAL_MAC( _z1, diag[2], _w0 );
			VAL_MAC( _z0, diag[1], _w1 );
			VAL_MAC( _z1, diag[3], _w1 );
			VAL_MAC( _y0, diag[0], _x0 );
			VAL_MAC( _y1, diag[2], _x0 );
			VAL_MAC( _y0, diag[1], _x1 );
			VAL_MAC( _y1, diag[3], _x1 );
		}
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_2x8)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 2*incy, zp += 2*incz, diag += 2*2 )
	{
		...
		/* Diag block multiply */
		{
			...
			REGISTER oski_value_t _x0;
			REGISTER oski_value_t _x1;
			const oski_value_t* wp = w + (d0 + I*2)*incw;
			REGISTER oski_value_t _w0;
			REGISTER oski_value_t _w1;
...
/**
 *  \brief Exported module wrapper for the \f$2\times 8\f$
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_2x8)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 2*incy, zp += 2*incz, diag += 2*2 )
	{
		...
		/* Diag block multiply */
		{
			...
			VAL_MAC_CONJ( _z1, diag[2], _w0 );
			VAL_MAC_CONJ( _z0, diag[1], _w1 );
			VAL_MAC_CONJ( _z1, diag[3], _w1 );
			VAL_MAC( _y0, diag[0], _x0 );
			VAL_MAC( _y1, diag[2], _x0 );
			VAL_MAC( _y0, diag[1], _x1 );
			VAL_MAC( _y1, diag[3], _x1 );
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_2x8)
#endif
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_2x8)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 2*incy, wp += 2*incw, diag += 2*2 )
	{
		oski_index_t K;
		REGISTER oski_value_t _y0;
		REGISTER oski_value_t _y1;
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_2x8)
#endif
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_2x8)
#endif
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_2x8)
#endif
...
#define SubmatReprMultAndSubmatReprTransMult \
	MANGLE_MOD_(SubmatReprMultAndSubmatReprTransMult_2x8)
#endif

/**
 *  \brief Entry point to the 2x8 kernel that implements
