/**
 *  \file src/MBCSR/MatMult/8x4.c
 *  \brief MBCSR 8x4 SpMV implementation, for all transpose options.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_symm.sh on Wed Jun  8 16:00:47 PDT 2005.
 */
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1_8x4)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*4 )
		{
			...
			VAL_MAC( _yp0, bval[4], _x1 );
			VAL_MAC( _yp1, bval[5], _x1 );
			VAL_MAC( _yp2, bval[6], _x1 );
			VAL_MAC( _yp3, bval[7], _x1 );
			VAL_MAC( _yp0, bval[8], _x2 );
			VAL_MAC( _yp1, bval[9], _x2 );
			VAL_MAC( _yp2, bval[10], _x2 );
			VAL_MAC( _yp3, bval[11], _x2 );
			VAL_MAC( _yp0, bval[12], _x3 );
			VAL_MAC( _yp1, bval[13], _x3 );
			VAL_MAC( _yp2, bval[14], _x3 );
			VAL_MAC( _yp3, bval[15], _x3 );
			VAL_MAC( _yp0, bval[16], _x4 );
			VAL_MAC( _yp1, bval[17], _x4 );
			VAL_MAC( _yp2, bval[18], _x4 );
			VAL_MAC( _yp3, bval[19], _x4 );
			VAL_MAC( _yp0, bval[20], _x5 );
			VAL_MAC( _yp1, bval[21], _x5 );
			VAL_MAC( _yp2, bval[22], _x5 );
			VAL_MAC( _yp3, bval[23], _x5 );
			VAL_MAC( _yp0, bval[24], _x6 );
			VAL_MAC( _yp1, bval[25], _x6 );
			VAL_MAC( _yp2, bval[26], _x6 );
			VAL_MAC( _yp3, bval[27], _x6 );
			VAL_MAC( _yp0, bval[28], _x7 );
			VAL_MAC( _yp1, bval[29], _x7 );
			VAL_MAC( _yp2, bval[30], _x7 );
			VAL_MAC( _yp3, bval[31], _x7 );
			VAL_MAC( _y0, bval[0], _xp0 );
			VAL_MAC( _y1, bval[4], _xp0 );
			VAL_MAC( _y2, bval[8], _xp0 );
			VAL_MAC( _y3, bval[12], _xp0 );
			VAL_MAC( _y4, bval[16], _xp0 );
			VAL_MAC( _y5, bval[20], _xp0 );
			VAL_MAC( _y6, bval[24], _xp0 );
			VAL_MAC( _y7, bval[28], _xp0 );
			VAL_MAC( _y0, bval[1], _xp1 );
			VAL_MAC( _y1, bval[5], _xp1 );
			VAL_MAC( _y2, bval[9], _xp1 );
			VAL_MAC( _y3, bval[13], _xp1 );
			VAL_MAC( _y4, bval[17], _xp1 );
			VAL_MAC( _y5, bval[21], _xp1 );
			VAL_MAC( _y6, bval[25], _xp1 );
			VAL_MAC( _y7, bval[29], _xp1 );
			VAL_MAC( _y0, bval[2], _xp2 );
			VAL_MAC( _y1, bval[6], _xp2 );
			VAL_MAC( _y2, bval[10], _xp2 );
			VAL_MAC( _y3, bval[14], _xp2 );
			VAL_MAC( _y4, bval[18], _xp2 );
			VAL_MAC( _y5, bval[22], _xp2 );
			VAL_MAC( _y6, bval[26], _xp2 );
			VAL_MAC( _y7, bval[30], _xp2 );
			VAL_MAC( _y0, bval[3], _xp3 );
			VAL_MAC( _y1, bval[7], _xp3 );
			VAL_MAC( _y2, bval[11], _xp3 );
			VAL_MAC( _y3, bval[15], _xp3 );
			VAL_MAC( _y4, bval[19], _xp3 );
			VAL_MAC( _y5, bval[23], _xp3 );
			VAL_MAC( _y6, bval[27], _xp3 );
			VAL_MAC( _y7, bval[31], _xp3 );
			VAL_INC( ypp[0], _yp0 );
			VAL_INC( ypp[1], _yp1 );
			VAL_INC( ypp[2], _yp2 );
			VAL_INC( ypp[3], _yp3 );
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX_8x4)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1_8x4)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX_8x4)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1_8x4)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*4 )
		{
			...
			VAL_MAC_CONJ( _yp0, bval[4], _x1 );
			VAL_MAC_CONJ( _yp1, bval[5], _x1 );
			VAL_MAC_CONJ( _yp2, bval[6], _x1 );
			VAL_MAC_CONJ( _yp3, bval[7], _x1 );
			VAL_MAC_CONJ( _yp0, bval[8], _x2 );
			VAL_MAC_CONJ( _yp1, bval[9], _x2 );
			VAL_MAC_CONJ( _yp2, bval[10], _x2 );
			VAL_MAC_CONJ( _yp3, bval[11], _x2 );
			VAL_MAC_CONJ( _yp0, bval[12], _x3 );
			VAL_MAC_CONJ( _yp1, bval[13], _x3 );
			VAL_MAC_CONJ( _yp2, bval[14], _x3 );
			VAL_MAC_CONJ( _yp3, bval[15], _x3 );
			VAL_MAC_CONJ( _yp0, bval[16], _x4 );
			VAL_MAC_CONJ( _yp1, bval[17], _x4 );
			VAL_MAC_CONJ( _yp2, bval[18], _x4 );
			VAL_MAC_CONJ( _yp3, bval[19], _x4 );
			VAL_MAC_CONJ( _yp0, bval[20], _x5 );
			VAL_MAC_CONJ( _yp1, bval[21], _x5 );
			VAL_MAC_CONJ( _yp2, bval[22], _x5 );
			VAL_MAC_CONJ( _yp3, bval[23], _x5 );
			VAL_MAC_CONJ( _yp0, bval[24], _x6 );
			VAL_MAC_CONJ( _yp1, bval[25], _x6 );
			VAL_MAC_CONJ( _yp2, bval[26], _x6 );
			VAL_MAC_CONJ( _yp3, bval[27], _x6 );
			VAL_MAC_CONJ( _yp0, bval[28], _x7 );
			VAL_MAC_CONJ( _yp1, bval[29], _x7 );
			VAL_MAC_CONJ( _yp2, bval[30], _x7 );
			VAL_MAC_CONJ( _yp3, bval[31], _x7 );
			VAL_MAC_CONJ( _y0, bval[0], _xp0 );
			VAL_MAC_CONJ( _y1, bval[4], _xp0 );
			VAL_MAC_CONJ( _y2, bval[8], _xp0 );
			VAL_MAC_CONJ( _y3, bval[12], _xp0 );
			VAL_MAC_CONJ( _y4, bval[16], _xp0 );
			VAL_MAC_CONJ( _y5, bval[20], _xp0 );
			VAL_MAC_CONJ( _y6, bval[24], _xp0 );
			VAL_MAC_CONJ( _y7, bval[28], _xp0 );
			VAL_MAC_CONJ( _y0, bval[1], _xp1 );
			VAL_MAC_CONJ( _y1, bval[5], _xp1 );
			VAL_MAC_CONJ( _y2, bval[9], _xp1 );
			VAL_MAC_CONJ( _y3, bval[13], _xp1 );
			VAL_MAC_CONJ( _y4, bval[17], _xp1 );
			VAL_MAC_CONJ( _y5, bval[21], _xp1 );
			VAL_MAC_CONJ( _y6, bval[25], _xp1 );
			VAL_MAC_CONJ( _y7, bval[29], _xp1 );
			VAL_MAC_CONJ( _y0, bval[2], _xp2 );
			VAL_MAC_CONJ( _y1, bval[6], _xp2 );
			VAL_MAC_CONJ( _y2, bval[10], _xp2 );
			VAL_MAC_CONJ( _y3, bval[14], _xp2 );
			VAL_MAC_CONJ( _y4, bval[18], _xp2 );
			VAL_MAC_CONJ( _y5, bval[22], _xp2 );
			VAL_MAC_CONJ( _y6, bval[26], _xp2 );
			VAL_MAC_CONJ( _y7, bval[30], _xp2 );
			VAL_MAC_CONJ( _y0, bval[3], _xp3 );
			VAL_MAC_CONJ( _y1, bval[7], _xp3 );
			VAL_MAC_CONJ( _y2, bval[11], _xp3 );
			VAL_MAC_CONJ( _y3, bval[15], _xp3 );
			VAL_MAC_CONJ( _y4, bval[19], _xp3 );
			VAL_MAC_CONJ( _y5, bval[23], _xp3 );
			VAL_MAC_CONJ( _y6, bval[27], _xp3 );
			VAL_MAC_CONJ( _y7, bval[31], _xp3 );
			VAL_INC( ypp[0], _yp0 );
			VAL_INC( ypp[1], _yp1 );
			VAL_INC( ypp[2], _yp2 );
			VAL_INC( ypp[3], _yp3 );
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX_8x4)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1_8x4)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX_8x4)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ys1_8x4)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ysX_8x4)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ys1_8x4)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ysX_8x4)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1_8x4)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX_8x4)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1_8x4)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX_8x4)
#endif
...
#define SymmSubmatReprMult MANGLE_MOD_(SymmSubmatReprMult_8x4)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 8x4 MBCSR format and
