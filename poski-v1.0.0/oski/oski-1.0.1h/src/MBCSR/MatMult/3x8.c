/**
 *  \file src/MBCSR/MatMult/3x8.c
 *  \brief MBCSR 3x8 SpMV implementation, for all transpose options.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen.sh on Wed Jun  8 15:52:20 PDT 2005.
 */
...
#define MBCSR_MatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_MatMult_v1_aX_b1_xs1_ysX_3x8)
#endif
	...
	oski_value_t* restrict y, oski_index_t incy )
{
	...
	for( I = 0, yp = y + d0*incy; I < M; I++, yp += 3*incy )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 3*8 )
		{
...
#define MBCSR_MatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatMult_v1_aX_b1_xsX_ysX_3x8)
#endif
...
#define MBCSR_MatTransMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_MatTransMult_v1_aX_b1_xsX_ys1_3x8)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0, xp = x + d0*incx; I < M; I++, xp += 3*incx )
	{
		REGISTER oski_value_t _x0;
		REGISTER oski_value_t _x1;
		REGISTER oski_value_t _x2;
	...
	for( I = 0, xp = x + d0*incx; I < M; I++, xp += 3*incx )
	{
		...
		VAL_MAC( _y0, bdiag[3], _x1 );
		VAL_MAC( _y1, bdiag[4], _x1 );
		VAL_MAC( _y2, bdiag[5], _x1 );
		VAL_MAC( _y0, bdiag[6], _x2 );
...
#define MBCSR_MatTransMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatTransMult_v1_aX_b1_xsX_ysX_3x8)
#endif
...
#define MBCSR_MatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_MatConjMult_v1_aX_b1_xs1_ysX_3x8)
#endif
...
#define MBCSR_MatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatConjMult_v1_aX_b1_xsX_ysX_3x8)
#endif
...
#define MBCSR_MatHermMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_MatHermMult_v1_aX_b1_xsX_ys1_3x8)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0, xp = x + d0*incx; I < M; I++, xp += 3*incx )
	{
		...
		VAL_MAC_CONJ( _y0, bdiag[3], _x1 );
		VAL_MAC_CONJ( _y1, bdiag[4], _x1 );
		VAL_MAC_CONJ( _y2, bdiag[5], _x1 );
		VAL_MAC_CONJ( _y0, bdiag[6], _x2 );
...
#define MBCSR_MatHermMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatHermMult_v1_aX_b1_xsX_ysX_3x8)
#endif
...
#define SubmatReprMult MANGLE_MOD_(SubmatReprMult_3x8)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 3x8 MBCSR format.
 */
int
