 ...
 *
 *  Automatically generated by ./gen_symm.sh on Wed Jun  8 16:00:40 PDT 2005.
 */
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1_8x3)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*3 )
		{
			...
			VAL_MAC( _yp0, bval[15], _x5 );
			VAL_MAC( _yp1, bval[16], _x5 );
			VAL_MAC( _yp2, bval[17], _x5 );
			VAL_MAC( _yp0, bval[18], _x6 );
			VAL_MAC( _yp1, bval[19], _x6 );
			VAL_MAC( _yp2, bval[20], _x6 );
			VAL_MAC( _yp0, bval[21], _x7 );
			VAL_MAC( _yp1, bval[22], _x7 );
			VAL_MAC( _yp2, bval[23], _x7 );
			VAL_MAC( _y0, bval[0], _xp0 );
			VAL_MAC( _y1, bval[3], _xp0 );
			VAL_MAC( _y2, bval[6], _xp0 );
			VAL_MAC( _y3, bval[9], _xp0 );
			VAL_MAC( _y4, bval[12], _xp0 );
			VAL_MAC( _y5, bval[15], _xp0 );
			VAL_MAC( _y6, bval[18], _xp0 );
			VAL_MAC( _y7, bval[21], _xp0 );
			VAL_MAC( _y0, bval[1], _xp1 );
			VAL_MAC( _y1, bval[4], _xp1 );
			VAL_MAC( _y2, bval[7], _xp1 );
			VAL_MAC( _y3, bval[10], _xp1 );
			VAL_MAC( _y4, bval[13], _xp1 );
			VAL_MAC( _y5, bval[16], _xp1 );
			VAL_MAC( _y6, bval[19], _xp1 );
			VAL_MAC( _y7, bval[22], _xp1 );
			VAL_MAC( _y0, bval[2], _xp2 );
			VAL_MAC( _y1, bval[5], _xp2 );
			VAL_MAC( _y2, bval[8], _xp2 );
			VAL_MAC( _y3, bval[11], _xp2 );
			VAL_MAC( _y4, bval[14], _xp2 );
			VAL_MAC( _y5, bval[17], _xp2 );
			VAL_MAC( _y6, bval[20], _xp2 );
			VAL_MAC( _y7, bval[23], _xp2 );
			VAL_INC( ypp[0], _yp0 );
			VAL_INC( ypp[1], _yp1 );
			VAL_INC( ypp[2], _yp2 );
		}
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX_8x3)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1_8x3)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX_8x3)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1_8x3)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*3 )
		{
			...
			VAL_MAC_CONJ( _yp0, bval[15], _x5 );
			VAL_MAC_CONJ( _yp1, bval[16], _x5 );
			VAL_MAC_CONJ( _yp2, bval[17], _x5 );
			VAL_MAC_CONJ( _yp0, bval[18], _x6 );
			VAL_MAC_CONJ( _yp1, bval[19], _x6 );
			VAL_MAC_CONJ( _yp2, bval[20], _x6 );
			VAL_MAC_CONJ( _yp0, bval[21], _x7 );
			VAL_MAC_CONJ( _yp1, bval[22], _x7 );
			VAL_MAC_CONJ( _yp2, bval[23], _x7 );
			...
			VAL_MAC_CONJ( _y5, bval[15], _xp0 );
			VAL_MAC_CONJ( _y6, bval[18], _xp0 );
			VAL_MAC_CONJ( _y7, bval[21], _xp0 );
			...
			VAL_MAC_CONJ( _y5, bval[16], _xp1 );
			VAL_MAC_CONJ( _y6, bval[19], _xp1 );
			VAL_MAC_CONJ( _y7, bval[22], _xp1 );
			...
			VAL_MAC_CONJ( _y5, bval[17], _xp2 );
			VAL_MAC_CONJ( _y6, bval[20], _xp2 );
			VAL_MAC_CONJ( _y7, bval[23], _xp2 );
			VAL_INC( ypp[0], _yp0 );
			VAL_INC( ypp[1], _yp1 );
			VAL_INC( ypp[2], _yp2 );
		}
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX_8x3)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1_8x3)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX_8x3)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ys1_8x3)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ysX_8x3)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ys1_8x3)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ysX_8x3)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1_8x3)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX_8x3)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1_8x3)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX_8x3)
#endif
...
#define SymmSubmatReprMult MANGLE_MOD_(SymmSubmatReprMult_8x3)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 8x3 MBCSR format and
