/**
 *  \file src/MBCSR/MatTrisolve/8x2.c
 ...
 *  on Wed Jun  8 16:09:37 PDT 2005.
 */
...
#include <oski/MBCSR/module.h>
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 8, dp += 8*8 )
	{
		...
		const oski_value_t* vp = val + ptr[I-1]*8*2;
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 8*2 )
		{
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xsX_8x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xsX_8x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 8, dp -= 8*8 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 8*2 )
		{
			...
			VAL_MSUB( _x0, vp[14], _b7 );
			VAL_MSUB( _x1, vp[15], _b7 );
			VAL_ASSIGN( xp[0], _x0 );
			VAL_ASSIGN( xp[1], _x1 );
		} /* K */
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xsX_8x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 8, dp -= 8*8 )
	{
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 8*2 )
		{
			...
			VAL_MSUB_CONJ( _x0, vp[14], _b7 );
			VAL_MSUB_CONJ( _x1, vp[15], _b7 );
			VAL_ASSIGN( xp[0], _x0 );
			VAL_ASSIGN( xp[1], _x1 );
		} /* K */
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xsX_8x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xsX_8x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xsX_8x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xsX_8x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xs1_8x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xsX_8x2)
#endif
...
#define SubmatReprTrisolve MANGLE_MOD_(SubmatReprTrisolve_8x2)
#endif

/**
 *  \brief Entry point to the 8x2 kernel that implements
