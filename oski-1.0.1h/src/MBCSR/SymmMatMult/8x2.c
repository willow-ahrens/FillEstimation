 ...
 *
 *  Automatically generated by ./gen_symm.sh on Wed Jun  8 16:00:35 PDT 2005.
 */
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1_8x2)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*2 )
		{
			...
			VAL_MAC( _yp0, bval[2], _x1 );
			VAL_MAC( _yp1, bval[3], _x1 );
			VAL_MAC( _yp0, bval[4], _x2 );
			VAL_MAC( _yp1, bval[5], _x2 );
			VAL_MAC( _yp0, bval[6], _x3 );
			VAL_MAC( _yp1, bval[7], _x3 );
			VAL_MAC( _yp0, bval[8], _x4 );
			VAL_MAC( _yp1, bval[9], _x4 );
			VAL_MAC( _yp0, bval[10], _x5 );
			VAL_MAC( _yp1, bval[11], _x5 );
			VAL_MAC( _yp0, bval[12], _x6 );
			VAL_MAC( _yp1, bval[13], _x6 );
			VAL_MAC( _yp0, bval[14], _x7 );
			VAL_MAC( _yp1, bval[15], _x7 );
			VAL_MAC( _y0, bval[0], _xp0 );
			VAL_MAC( _y1, bval[2], _xp0 );
			VAL_MAC( _y2, bval[4], _xp0 );
			VAL_MAC( _y3, bval[6], _xp0 );
			VAL_MAC( _y4, bval[8], _xp0 );
			VAL_MAC( _y5, bval[10], _xp0 );
			VAL_MAC( _y6, bval[12], _xp0 );
			VAL_MAC( _y7, bval[14], _xp0 );
			VAL_MAC( _y0, bval[1], _xp1 );
			VAL_MAC( _y1, bval[3], _xp1 );
			VAL_MAC( _y2, bval[5], _xp1 );
			VAL_MAC( _y3, bval[7], _xp1 );
			VAL_MAC( _y4, bval[9], _xp1 );
			VAL_MAC( _y5, bval[11], _xp1 );
			VAL_MAC( _y6, bval[13], _xp1 );
			VAL_MAC( _y7, bval[15], _xp1 );
			VAL_INC( ypp[0], _yp0 );
			VAL_INC( ypp[1], _yp1 );
		}
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX_8x2)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1_8x2)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX_8x2)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1_8x2)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*2 )
		{
			...
			VAL_MAC_CONJ( _yp0, bval[2], _x1 );
			VAL_MAC_CONJ( _yp1, bval[3], _x1 );
			VAL_MAC_CONJ( _yp0, bval[4], _x2 );
			VAL_MAC_CONJ( _yp1, bval[5], _x2 );
			VAL_MAC_CONJ( _yp0, bval[6], _x3 );
			VAL_MAC_CONJ( _yp1, bval[7], _x3 );
			VAL_MAC_CONJ( _yp0, bval[8], _x4 );
			VAL_MAC_CONJ( _yp1, bval[9], _x4 );
			VAL_MAC_CONJ( _yp0, bval[10], _x5 );
			VAL_MAC_CONJ( _yp1, bval[11], _x5 );
			VAL_MAC_CONJ( _yp0, bval[12], _x6 );
			VAL_MAC_CONJ( _yp1, bval[13], _x6 );
			VAL_MAC_CONJ( _yp0, bval[14], _x7 );
			VAL_MAC_CONJ( _yp1, bval[15], _x7 );
			VAL_MAC_CONJ( _y0, bval[0], _xp0 );
			VAL_MAC_CONJ( _y1, bval[2], _xp0 );
			VAL_MAC_CONJ( _y2, bval[4], _xp0 );
			VAL_MAC_CONJ( _y3, bval[6], _xp0 );
			VAL_MAC_CONJ( _y4, bval[8], _xp0 );
			VAL_MAC_CONJ( _y5, bval[10], _xp0 );
			VAL_MAC_CONJ( _y6, bval[12], _xp0 );
			VAL_MAC_CONJ( _y7, bval[14], _xp0 );
			VAL_MAC_CONJ( _y0, bval[1], _xp1 );
			VAL_MAC_CONJ( _y1, bval[3], _xp1 );
			VAL_MAC_CONJ( _y2, bval[5], _xp1 );
			VAL_MAC_CONJ( _y3, bval[7], _xp1 );
			VAL_MAC_CONJ( _y4, bval[9], _xp1 );
			VAL_MAC_CONJ( _y5, bval[11], _xp1 );
			VAL_MAC_CONJ( _y6, bval[13], _xp1 );
			VAL_MAC_CONJ( _y7, bval[15], _xp1 );
			VAL_INC( ypp[0], _yp0 );
			VAL_INC( ypp[1], _yp1 );
		}
		VAL_MAC( yp[0], alpha, _y0 );
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX_8x2)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1_8x2)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX_8x2)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ys1_8x2)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ysX_8x2)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ys1_8x2)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ysX_8x2)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1_8x2)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX_8x2)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1_8x2)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX_8x2)
#endif
...
#define SymmSubmatReprMult MANGLE_MOD_(SymmSubmatReprMult_8x2)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 8x2 MBCSR format and
