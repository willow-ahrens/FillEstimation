 ...
 *
 *  Automatically generated by ./gen.sh on Wed Jun  8 15:52:12 PDT 2005.
 */
...
#define MBCSR_MatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_MatMult_v1_aX_b1_xs1_ysX_1x7)
#endif
	...
	oski_value_t* restrict y, oski_index_t incy )
{
	...
	for( I = 0, yp = y + d0*incy; I < M; I++, yp += 1*incy )
	{
...
#define MBCSR_MatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatMult_v1_aX_b1_xsX_ysX_1x7)
#endif
...
#define MBCSR_MatTransMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_MatTransMult_v1_aX_b1_xsX_ys1_1x7)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0, xp = x + d0*incx; I < M; I++, xp += 1*incx )
	{
		REGISTER oski_value_t _x0;
		oski_index_t K;
...
#define MBCSR_MatTransMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatTransMult_v1_aX_b1_xsX_ysX_1x7)
#endif
...
#define MBCSR_MatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_MatConjMult_v1_aX_b1_xs1_ysX_1x7)
#endif
...
#define MBCSR_MatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatConjMult_v1_aX_b1_xsX_ysX_1x7)
#endif
...
#define MBCSR_MatHermMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_MatHermMult_v1_aX_b1_xsX_ys1_1x7)
#endif
...
#define MBCSR_MatHermMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatHermMult_v1_aX_b1_xsX_ysX_1x7)
#endif
...
#define SubmatReprMult MANGLE_MOD_(SubmatReprMult_1x7)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 1x7 MBCSR format.
 */
int
