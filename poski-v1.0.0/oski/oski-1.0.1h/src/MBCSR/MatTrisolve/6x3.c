/**
 *  \file src/MBCSR/MatTrisolve/6x3.c
 ...
 *  on Wed Jun  8 16:07:21 PDT 2005.
 */
...
#include <oski/MBCSR/module.h>
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 6, dp += 6*6 )
	{
		...
		const oski_value_t* vp = val + ptr[I-1]*6*3;
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 6*3 )
		{
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xsX_6x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xsX_6x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xsX_6x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xsX_6x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xsX_6x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xsX_6x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xsX_6x3)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xs1_6x3)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xsX_6x3)
#endif
...
#define SubmatReprTrisolve MANGLE_MOD_(SubmatReprTrisolve_6x3)
#endif
