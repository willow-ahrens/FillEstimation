/**
 *  \file src/MBCSR/MatMultAndMatTransMult/8x5.c
 ...
 *
 *  Automatically generated by ./gen_a_and_at.sh on Wed Jun  8 16:07:18 PDT 2005.
 */
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_8x5)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, zp += 8*incz, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*5 )
		{
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x5)
#endif
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_8x5)
#endif
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x5)
#endif
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_8x5)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, wp += 8*incw, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*5 )
		{
			...
			VAL_MAC( _z0, val[35], _w7 );
			VAL_MAC( _z1, val[36], _w7 );
			VAL_MAC( _z2, val[37], _w7 );
			VAL_MAC( _z3, val[38], _w7 );
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x5)
#endif
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_8x5)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, wp += 8*incw, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*5 )
		{
			...
			VAL_MAC_CONJ( _z0, val[35], _w7 );
			VAL_MAC_CONJ( _z1, val[36], _w7 );
			VAL_MAC_CONJ( _z2, val[37], _w7 );
			VAL_MAC_CONJ( _z3, val[38], _w7 );
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x5)
#endif
...
#define SubmatReprMultAndSubmatReprTransMult \
	MANGLE_MOD_(SubmatReprMultAndSubmatReprTransMult_8x5)
#endif

/**
 *  \brief Entry point to the 8x5 kernel that implements
