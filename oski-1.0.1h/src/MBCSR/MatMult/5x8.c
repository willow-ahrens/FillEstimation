/**
 *  \file src/MBCSR/MatMult/5x8.c
 *  \brief MBCSR 5x8 SpMV implementation, for all transpose options.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen.sh on Wed Jun  8 15:52:31 PDT 2005.
 */
...
#define MBCSR_MatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_MatMult_v1_aX_b1_xs1_ysX_5x8)
#endif
	...
	oski_value_t* restrict y, oski_index_t incy )
{
	...
	for( I = 0, yp = y + d0*incy; I < M; I++, yp += 5*incy )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 5*8 )
		{
...
#define MBCSR_MatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatMult_v1_aX_b1_xsX_ysX_5x8)
#endif
...
#define MBCSR_MatTransMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_MatTransMult_v1_aX_b1_xsX_ys1_5x8)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0, xp = x + d0*incx; I < M; I++, xp += 5*incx )
	{
		REGISTER oski_value_t _x0;
		REGISTER oski_value_t _x1;
		REGISTER oski_value_t _x2;
	...
	for( I = 0, xp = x + d0*incx; I < M; I++, xp += 5*incx )
	{
		...
		VAL_MAC( _y0, bdiag[5], _x1 );
		VAL_MAC( _y1, bdiag[6], _x1 );
		VAL_MAC( _y2, bdiag[7], _x1 );
		VAL_MAC( _y3, bdiag[8], _x1 );
		VAL_MAC( _y4, bdiag[9], _x1 );
		VAL_MAC( _y0, bdiag[10], _x2 );
		VAL_MAC( _y1, bdiag[11], _x2 );
		VAL_MAC( _y2, bdiag[12], _x2 );
		VAL_MAC( _y3, bdiag[13], _x2 );
		VAL_MAC( _y4, bdiag[14], _x2 );
		VAL_MAC( _y0, bdiag[15], _x3 );
		VAL_MAC( _y1, bdiag[16], _x3 );
		VAL_MAC( _y2, bdiag[17], _x3 );
		VAL_MAC( _y3, bdiag[18], _x3 );
		VAL_MAC( _y4, bdiag[19], _x3 );
		VAL_MAC( _y0, bdiag[20], _x4 );
		VAL_MAC( _y1, bdiag[21], _x4 );
		VAL_MAC( _y2, bdiag[22], _x4 );
		VAL_MAC( _y3, bdiag[23], _x4 );
		VAL_MAC( _y4, bdiag[24], _x4 );
		VAL_INC( yp[0], _y0 );
		VAL_INC( yp[1], _y1 );
		VAL_INC( yp[2], _y2 );
...
#define MBCSR_MatTransMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatTransMult_v1_aX_b1_xsX_ysX_5x8)
#endif
...
#define MBCSR_MatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_MatConjMult_v1_aX_b1_xs1_ysX_5x8)
#endif
...
#define MBCSR_MatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatConjMult_v1_aX_b1_xsX_ysX_5x8)
#endif
...
#define MBCSR_MatHermMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_MatHermMult_v1_aX_b1_xsX_ys1_5x8)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0, xp = x + d0*incx; I < M; I++, xp += 5*incx )
	{
		...
		VAL_MAC_CONJ( _y0, bdiag[5], _x1 );
		VAL_MAC_CONJ( _y1, bdiag[6], _x1 );
		VAL_MAC_CONJ( _y2, bdiag[7], _x1 );
		VAL_MAC_CONJ( _y3, bdiag[8], _x1 );
		VAL_MAC_CONJ( _y4, bdiag[9], _x1 );
		VAL_MAC_CONJ( _y0, bdiag[10], _x2 );
		VAL_MAC_CONJ( _y1, bdiag[11], _x2 );
		VAL_MAC_CONJ( _y2, bdiag[12], _x2 );
		VAL_MAC_CONJ( _y3, bdiag[13], _x2 );
		VAL_MAC_CONJ( _y4, bdiag[14], _x2 );
		VAL_MAC_CONJ( _y0, bdiag[15], _x3 );
		VAL_MAC_CONJ( _y1, bdiag[16], _x3 );
		VAL_MAC_CONJ( _y2, bdiag[17], _x3 );
		VAL_MAC_CONJ( _y3, bdiag[18], _x3 );
		VAL_MAC_CONJ( _y4, bdiag[19], _x3 );
		VAL_MAC_CONJ( _y0, bdiag[20], _x4 );
		VAL_MAC_CONJ( _y1, bdiag[21], _x4 );
		VAL_MAC_CONJ( _y2, bdiag[22], _x4 );
		VAL_MAC_CONJ( _y3, bdiag[23], _x4 );
		VAL_MAC_CONJ( _y4, bdiag[24], _x4 );
		VAL_INC( yp[0], _y0 );
		VAL_INC( yp[1], _y1 );
		VAL_INC( yp[2], _y2 );
...
#define MBCSR_MatHermMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_MatHermMult_v1_aX_b1_xsX_ysX_5x8)
#endif
...
#define SubmatReprMult MANGLE_MOD_(SubmatReprMult_5x8)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 5x8 MBCSR format.
 */
int
