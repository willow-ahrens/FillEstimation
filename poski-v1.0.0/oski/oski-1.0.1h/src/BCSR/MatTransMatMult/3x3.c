/**
 *  \file src/BCSR/MatTransMatMult/BCSR_3x3.c
 *  \brief The \f$3\times 3\f$ BCSR implementation
...
#define BCSR_MatTransMatMult_v1_aX_b1_xs1_ys1 \
	MANGLE_MOD_(BCSR_MatTransMatMult_v1_aX_b1_xs1_ys1_3x3)
#endif
	...
	oski_value_t* restrict t, oski_index_t inct )
{
	...
	for( I = 0; I < M; I++ )
	{
		...
		for( K = ptr[I], vp = val; K < ptr[I+1]; K++, vp += 3*3 )
		{
...
#define BCSR_MatTransMatMult_v1_aX_b1_xsX_ysX \
	MANGLE_MOD_(BCSR_MatTransMatMult_v1_aX_b1_xsX_ysX_3x3)
#endif
...
#define MatReprTransMatReprMult MANGLE_MOD_(MatReprTransMatReprMult_3x3)
#endif
...
#define BCSR_MatHermMatMult_v1_aX_b1_xs1_ys1 \
	MANGLE_MOD_(BCSR_MatHermMatMult_v1_aX_b1_xs1_ys1_3x3)
#endif
...
#define BCSR_MatHermMatMult_v1_aX_b1_xsX_ysX \
	MANGLE_MOD_(BCSR_MatHermMatMult_v1_aX_b1_xsX_ysX_3x3)
#endif
...
#define MatReprHermMatReprMult MANGLE_MOD_(MatReprHermMatReprMult_3x3)
#endif
