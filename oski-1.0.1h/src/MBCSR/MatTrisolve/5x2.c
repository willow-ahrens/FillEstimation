/**
 *  \file src/MBCSR/MatTrisolve/5x2.c
 *  \brief The \f$5\times 2\f$ MBCSR implementation
 *  of sparse triangular solve.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_trisolve.sh
 *  on Wed Jun  8 16:05:39 PDT 2005.
 */
...
#include <oski/MBCSR/module.h>
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 5, dp += 5*5 )
	{
		...
		const oski_value_t* vp = val + ptr[I-1]*5*2;
		...
		for( K = ptr[I-1]; K < ptr[I]; K++, vp += 5*2 )
		{
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xsX_5x2)
#endif
...
/**
 *  \brief Exported module wrapper for the \f$5\times 2\f$
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xsX_5x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xsX_5x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xsX_5x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xsX_5x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xsX_5x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xsX_5x2)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xs1_5x2)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xsX_5x2)
#endif
...
#define SubmatReprTrisolve MANGLE_MOD_(SubmatReprTrisolve_5x2)
#endif

/**
 *  \brief Entry point to the 5x2 kernel that implements
