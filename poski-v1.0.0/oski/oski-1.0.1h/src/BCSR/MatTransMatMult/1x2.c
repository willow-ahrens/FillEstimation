/**
 *  \file src/BCSR/MatTransMatMult/BCSR_1x2.c
 *  \brief The \f$1\times 2\f$ BCSR implementation
...
#define BCSR_MatTransMatMult_v1_aX_b1_xs1_ys1 \
	MANGLE_MOD_(BCSR_MatTransMatMult_v1_aX_b1_xs1_ys1_1x2)
#endif
	...
	oski_value_t* restrict t, oski_index_t inct )
{
	...
	for( I = 0; I < M; I++ )
	{
		...
		for( K = ptr[I], vp = val; K < ptr[I+1]; K++, vp += 1*2 )
		{
...
#define BCSR_MatTransMatMult_v1_aX_b1_xsX_ysX \
	MANGLE_MOD_(BCSR_MatTransMatMult_v1_aX_b1_xsX_ysX_1x2)
#endif
...
#define MatReprTransMatReprMult MANGLE_MOD_(MatReprTransMatReprMult_1x2)
#endif
...
#define BCSR_MatHermMatMult_v1_aX_b1_xs1_ys1 \
	MANGLE_MOD_(BCSR_MatHermMatMult_v1_aX_b1_xs1_ys1_1x2)
#endif
...
#define BCSR_MatHermMatMult_v1_aX_b1_xsX_ysX \
	MANGLE_MOD_(BCSR_MatHermMatMult_v1_aX_b1_xsX_ysX_1x2)
#endif
...
#define MatReprHermMatReprMult MANGLE_MOD_(MatReprHermMatReprMult_1x2)
#endif
