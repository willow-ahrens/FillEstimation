/**
 *  \file src/MBCSR/MatMultAndMatTransMult/4x8.c
 *  \brief The \f$4\times 8\f$ MBCSR implementation
 *  of simultaneous multiplication by \f$A\f$ and \f$\mathrm{op}(A)\f$.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_a_and_at.sh on Wed Jun  8 15:55:19 PDT 2005.
 */
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_4x8)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 4*incy, zp += 4*incz, diag += 4*4 )
	{
		oski_index_t K;
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 4*8 )
		{
		...
		/* Diag block multiply */
		{
			...
			REGISTER oski_value_t _x2;
			REGISTER oski_value_t _x3;
			const oski_value_t* wp = w + (d0 + I*4);
			REGISTER oski_value_t _w0;
			REGISTER oski_value_t _w1;
			REGISTER oski_value_t _w2;
			REGISTER oski_value_t _w3;
			...
			VAL_MAC( _z1, diag[4], _w0 );
			VAL_MAC( _z2, diag[8], _w0 );
			VAL_MAC( _z3, diag[12], _w0 );
			VAL_MAC( _z0, diag[1], _w1 );
			VAL_MAC( _z1, diag[5], _w1 );
			VAL_MAC( _z2, diag[9], _w1 );
			VAL_MAC( _z3, diag[13], _w1 );
			VAL_MAC( _z0, diag[2], _w2 );
			VAL_MAC( _z1, diag[6], _w2 );
			VAL_MAC( _z2, diag[10], _w2 );
			VAL_MAC( _z3, diag[14], _w2 );
			VAL_MAC( _z0, diag[3], _w3 );
			VAL_MAC( _z1, diag[7], _w3 );
			VAL_MAC( _z2, diag[11], _w3 );
			VAL_MAC( _z3, diag[15], _w3 );
			VAL_MAC( _y0, diag[0], _x0 );
			VAL_MAC( _y1, diag[4], _x0 );
			VAL_MAC( _y2, diag[8], _x0 );
			VAL_MAC( _y3, diag[12], _x0 );
			VAL_MAC( _y0, diag[1], _x1 );
			VAL_MAC( _y1, diag[5], _x1 );
			VAL_MAC( _y2, diag[9], _x1 );
			VAL_MAC( _y3, diag[13], _x1 );
			VAL_MAC( _y0, diag[2], _x2 );
			VAL_MAC( _y1, diag[6], _x2 );
			VAL_MAC( _y2, diag[10], _x2 );
			VAL_MAC( _y3, diag[14], _x2 );
			VAL_MAC( _y0, diag[3], _x3 );
			VAL_MAC( _y1, diag[7], _x3 );
			VAL_MAC( _y2, diag[11], _x3 );
			VAL_MAC( _y3, diag[15], _x3 );
		}
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_4x8)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 4*incy, zp += 4*incz, diag += 4*4 )
	{
		...
		/* Diag block multiply */
		{
			...
			REGISTER oski_value_t _x2;
			REGISTER oski_value_t _x3;
			const oski_value_t* wp = w + (d0 + I*4)*incw;
			REGISTER oski_value_t _w0;
			REGISTER oski_value_t _w1;
			REGISTER oski_value_t _w2;
			REGISTER oski_value_t _w3;
...
/**
 *  \brief Exported module wrapper for the \f$4\times 8\f$
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_4x8)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 4*incy, zp += 4*incz, diag += 4*4 )
	{
		...
		/* Diag block multiply */
		{
			...
			VAL_MAC_CONJ( _z1, diag[4], _w0 );
			VAL_MAC_CONJ( _z2, diag[8], _w0 );
			VAL_MAC_CONJ( _z3, diag[12], _w0 );
			VAL_MAC_CONJ( _z0, diag[1], _w1 );
			VAL_MAC_CONJ( _z1, diag[5], _w1 );
			VAL_MAC_CONJ( _z2, diag[9], _w1 );
			VAL_MAC_CONJ( _z3, diag[13], _w1 );
			VAL_MAC_CONJ( _z0, diag[2], _w2 );
			VAL_MAC_CONJ( _z1, diag[6], _w2 );
			VAL_MAC_CONJ( _z2, diag[10], _w2 );
			VAL_MAC_CONJ( _z3, diag[14], _w2 );
			VAL_MAC_CONJ( _z0, diag[3], _w3 );
			VAL_MAC_CONJ( _z1, diag[7], _w3 );
			VAL_MAC_CONJ( _z2, diag[11], _w3 );
			VAL_MAC_CONJ( _z3, diag[15], _w3 );
			VAL_MAC( _y0, diag[0], _x0 );
			VAL_MAC( _y1, diag[4], _x0 );
			VAL_MAC( _y2, diag[8], _x0 );
			VAL_MAC( _y3, diag[12], _x0 );
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_4x8)
#endif
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_4x8)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 4*incy, wp += 4*incw, diag += 4*4 )
	{
		oski_index_t K;
		REGISTER oski_value_t _y0;
		REGISTER oski_value_t _y1;
		...
		/* Diag block multiply */
		{
			...
			VAL_MAC( _z0, diag[4], _w1 );
			VAL_MAC( _z1, diag[5], _w1 );
			VAL_MAC( _z2, diag[6], _w1 );
			VAL_MAC( _z3, diag[7], _w1 );
			VAL_MAC( _z0, diag[8], _w2 );
			VAL_MAC( _z1, diag[9], _w2 );
			VAL_MAC( _z2, diag[10], _w2 );
			VAL_MAC( _z3, diag[11], _w2 );
			VAL_MAC( _z0, diag[12], _w3 );
			VAL_MAC( _z1, diag[13], _w3 );
			VAL_MAC( _z2, diag[14], _w3 );
			VAL_MAC( _z3, diag[15], _w3 );
			VAL_MAC( _y0, diag[0], _x0 );
			VAL_MAC( _y1, diag[4], _x0 );
			VAL_MAC( _y2, diag[8], _x0 );
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_4x8)
#endif
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_4x8)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 4*incy, wp += 4*incw, diag += 4*4 )
	{
		...
		/* Diag block multiply */
		{
			...
			VAL_MAC_CONJ( _z0, diag[4], _w1 );
			VAL_MAC_CONJ( _z1, diag[5], _w1 );
			VAL_MAC_CONJ( _z2, diag[6], _w1 );
			VAL_MAC_CONJ( _z3, diag[7], _w1 );
			VAL_MAC_CONJ( _z0, diag[8], _w2 );
			VAL_MAC_CONJ( _z1, diag[9], _w2 );
			VAL_MAC_CONJ( _z2, diag[10], _w2 );
			VAL_MAC_CONJ( _z3, diag[11], _w2 );
			VAL_MAC_CONJ( _z0, diag[12], _w3 );
			VAL_MAC_CONJ( _z1, diag[13], _w3 );
			VAL_MAC_CONJ( _z2, diag[14], _w3 );
			VAL_MAC_CONJ( _z3, diag[15], _w3 );
			VAL_MAC( _y0, diag[0], _x0 );
			VAL_MAC( _y1, diag[4], _x0 );
			VAL_MAC( _y2, diag[8], _x0 );
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_4x8)
#endif
...
#define SubmatReprMultAndSubmatReprTransMult \
	MANGLE_MOD_(SubmatReprMultAndSubmatReprTransMult_4x8)
#endif

/**
 *  \brief Entry point to the 4x8 kernel that implements
