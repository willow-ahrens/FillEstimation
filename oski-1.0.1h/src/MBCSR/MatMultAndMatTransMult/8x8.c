/**
 *  \file src/MBCSR/MatMultAndMatTransMult/8x8.c
 ...
 *
 *  Automatically generated by ./gen_a_and_at.sh on Wed Jun  8 16:08:22 PDT 2005.
 */
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_8x8)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, zp += 8*incz, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*8 )
		{
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x8)
#endif
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_8x8)
#endif
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x8)
#endif
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_8x8)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, wp += 8*incw, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*8 )
		{
			...
			VAL_MAC( _z0, val[56], _w7 );
			VAL_MAC( _z1, val[57], _w7 );
			VAL_MAC( _z2, val[58], _w7 );
			VAL_MAC( _z3, val[59], _w7 );
			VAL_MAC( _z4, val[60], _w7 );
			VAL_MAC( _z5, val[61], _w7 );
			VAL_MAC( _z6, val[62], _w7 );
			VAL_MAC( _z7, val[63], _w7 );
			VAL_MAC( _y0, val[0], _x0 );
			VAL_MAC( _y1, val[8], _x0 );
			VAL_MAC( _y2, val[16], _x0 );
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x8)
#endif
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_8x8)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, wp += 8*incw, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*8 )
		{
			...
			VAL_MAC_CONJ( _z0, val[56], _w7 );
			VAL_MAC_CONJ( _z1, val[57], _w7 );
			VAL_MAC_CONJ( _z2, val[58], _w7 );
			VAL_MAC_CONJ( _z3, val[59], _w7 );
			VAL_MAC_CONJ( _z4, val[60], _w7 );
			VAL_MAC_CONJ( _z5, val[61], _w7 );
			VAL_MAC_CONJ( _z6, val[62], _w7 );
			VAL_MAC_CONJ( _z7, val[63], _w7 );
			VAL_MAC( _y0, val[0], _x0 );
			VAL_MAC( _y1, val[8], _x0 );
			VAL_MAC( _y2, val[16], _x0 );
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x8)
#endif
...
#define SubmatReprMultAndSubmatReprTransMult \
	MANGLE_MOD_(SubmatReprMultAndSubmatReprTransMult_8x8)
#endif
