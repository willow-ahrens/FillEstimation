/**
 *  \file src/MBCSR/MatMultAndMatTransMult/8x6.c
 ...
 *
 *  Automatically generated by ./gen_a_and_at.sh on Wed Jun  8 16:07:43 PDT 2005.
 */
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_8x6)
#endif
	...
	oski_value_t* restrict z, oski_index_t incz )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, zp += 8*incz, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*6 )
		{
...
#define MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x6)
#endif
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xs1_ysX_oX_z1_ws1_zsX_8x6)
#endif
...
#define MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatConjMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x6)
#endif
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_8x6)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, wp += 8*incw, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*6 )
		{
			...
			VAL_MAC( _z0, val[42], _w7 );
			VAL_MAC( _z1, val[43], _w7 );
			VAL_MAC( _z2, val[44], _w7 );
			VAL_MAC( _z3, val[45], _w7 );
			VAL_MAC( _z4, val[46], _w7 );
...
#define MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatTransMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x6)
#endif
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1 \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xs1_ysX_oX_z1_wsX_zs1_8x6)
#endif
	...
	oski_value_t* restrict z )
{
	...
	for( I = 0; I < M; I++, yp += 8*incy, wp += 8*incw, diag += 8*8 )
	{
		...
		for( K = ptr[I]; K < ptr[I+1]; K++, val += 8*6 )
		{
			...
			VAL_MAC_CONJ( _z0, val[42], _w7 );
			VAL_MAC_CONJ( _z1, val[43], _w7 );
			VAL_MAC_CONJ( _z2, val[44], _w7 );
			VAL_MAC_CONJ( _z3, val[45], _w7 );
			VAL_MAC_CONJ( _z4, val[46], _w7 );
...
#define MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX \
	MANGLE_MOD_(MBCSR_MatMultAndMatHermMult_v1_aX_b1_xsX_ysX_oX_z1_wsX_zsX_8x6)
#endif
...
#define SubmatReprMultAndSubmatReprTransMult \
	MANGLE_MOD_(SubmatReprMultAndSubmatReprTransMult_8x6)
#endif

/**
 *  \brief Entry point to the 8x6 kernel that implements
