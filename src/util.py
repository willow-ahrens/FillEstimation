...
def parse(parser):
  parser.add_argument("-e", "--experiment", help="an experiment parameters file (default = {0})".format(os.path.join(top, "run/default_experiment.py")), type=str, default = os.path.join(top, "run/default_experiment.py"))
