/**
 *  \file src/MBCSR/MatTransMatMult/8x8.c
 *  \brief The \f$8\times 8\f$ MBCSR implementation
 *  of \f$A^TA\cdot x\f$ and \f$A^HA\cdot x\f$.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_ata.sh on Wed Jun  8 16:05:13 PDT 2005.
 */
...
#define MBCSR_MatTransMatMult_v1_aX_b1_xs1_ys1 \
	MANGLE_MOD_(MBCSR_MatTransMatMult_v1_aX_b1_xs1_ys1_8x8)
#endif
	...
	oski_value_t* restrict t, oski_index_t inct )
{
	...
	for( I = 0; I < M; I++ )
	{
		...
		for( K = ptr[I], vp = val; K < ptr[I+1]; K++, vp += 8*8 )
		{
		...
		for( K = ptr[I], vp = val; K < ptr[I+1]; K++, vp += 8*8 )
		{
			...
			VAL_MAC( _y0, vp[40], _t5 );
			VAL_MAC( _y1, vp[41], _t5 );
			VAL_MAC( _y2, vp[42], _t5 );
			VAL_MAC( _y3, vp[43], _t5 );
			VAL_MAC( _y4, vp[44], _t5 );
			VAL_MAC( _y5, vp[45], _t5 );
			VAL_MAC( _y6, vp[46], _t5 );
			VAL_MAC( _y7, vp[47], _t5 );
			VAL_MAC( _y0, vp[48], _t6 );
			VAL_MAC( _y1, vp[49], _t6 );
			VAL_MAC( _y2, vp[50], _t6 );
			VAL_MAC( _y3, vp[51], _t6 );
			VAL_MAC( _y4, vp[52], _t6 );
			VAL_MAC( _y5, vp[53], _t6 );
			VAL_MAC( _y6, vp[54], _t6 );
			VAL_MAC( _y7, vp[55], _t6 );
			VAL_MAC( _y0, vp[56], _t7 );
			VAL_MAC( _y1, vp[57], _t7 );
			VAL_MAC( _y2, vp[58], _t7 );
			VAL_MAC( _y3, vp[59], _t7 );
			VAL_MAC( _y4, vp[60], _t7 );
			VAL_MAC( _y5, vp[61], _t7 );
			VAL_MAC( _y6, vp[62], _t7 );
			VAL_MAC( _y7, vp[63], _t7 );
			VAL_INC( yp[0], _y0 );
			VAL_INC( yp[1], _y1 );
			VAL_INC( yp[2], _y2 );
			VAL_INC( yp[3], _y3 );
...
#define MBCSR_MatTransMatMult_v1_aX_b1_xsX_ysX \
	MANGLE_MOD_(MBCSR_MatTransMatMult_v1_aX_b1_xsX_ysX_8x8)
#endif
...
#define SubmatReprTransSubmatReprMult \
	MANGLE_MOD_(SubmatReprTransSubmatReprMult_8x8)
#endif
...
#define MBCSR_MatHermMatMult_v1_aX_b1_xs1_ys1 \
	MANGLE_MOD_(MBCSR_MatHermMatMult_v1_aX_b1_xs1_ys1_8x8)
#endif
	...
	oski_value_t* restrict t, oski_index_t inct )
{
	...
	for( I = 0; I < M; I++ )
	{
		...
		for( K = ptr[I], vp = val; K < ptr[I+1]; K++, vp += 8*8 )
		{
			...
			VAL_MAC_CONJ( _y0, vp[40], _t5 );
			VAL_MAC_CONJ( _y1, vp[41], _t5 );
			VAL_MAC_CONJ( _y2, vp[42], _t5 );
			VAL_MAC_CONJ( _y3, vp[43], _t5 );
			VAL_MAC_CONJ( _y4, vp[44], _t5 );
			VAL_MAC_CONJ( _y5, vp[45], _t5 );
			VAL_MAC_CONJ( _y6, vp[46], _t5 );
			VAL_MAC_CONJ( _y7, vp[47], _t5 );
			VAL_MAC_CONJ( _y0, vp[48], _t6 );
			VAL_MAC_CONJ( _y1, vp[49], _t6 );
			VAL_MAC_CONJ( _y2, vp[50], _t6 );
			VAL_MAC_CONJ( _y3, vp[51], _t6 );
			VAL_MAC_CONJ( _y4, vp[52], _t6 );
			VAL_MAC_CONJ( _y5, vp[53], _t6 );
			VAL_MAC_CONJ( _y6, vp[54], _t6 );
			VAL_MAC_CONJ( _y7, vp[55], _t6 );
			VAL_MAC_CONJ( _y0, vp[56], _t7 );
			VAL_MAC_CONJ( _y1, vp[57], _t7 );
			VAL_MAC_CONJ( _y2, vp[58], _t7 );
			VAL_MAC_CONJ( _y3, vp[59], _t7 );
			VAL_MAC_CONJ( _y4, vp[60], _t7 );
			VAL_MAC_CONJ( _y5, vp[61], _t7 );
			VAL_MAC_CONJ( _y6, vp[62], _t7 );
			VAL_MAC_CONJ( _y7, vp[63], _t7 );
			VAL_INC( yp[0], _y0 );
			VAL_INC( yp[1], _y1 );
			VAL_INC( yp[2], _y2 );
			VAL_INC( yp[3], _y3 );
...
#define MBCSR_MatHermMatMult_v1_aX_b1_xsX_ysX \
	MANGLE_MOD_(MBCSR_MatHermMatMult_v1_aX_b1_xsX_ysX_8x8)
#endif
...
#define SubmatReprHermSubmatReprMult \
	MANGLE_MOD_(SubmatReprHermSubmatReprMult_8x8)
#endif
