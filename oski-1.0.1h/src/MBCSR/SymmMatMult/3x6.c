/**
 *  \file src/MBCSR/MatMult/3x6.c
 *  \brief MBCSR 3x6 SpMV implementation, for all transpose options.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_symm.sh on Wed Jun  8 15:57:44 PDT 2005.
 */
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1_3x6)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 3, xp += 3 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 3*6 )
		{
	...
	yp = y + d0;
	xp = x + d0;
	for( I = 0; I < M; I++, bdiag += 3*3, yp += 3, xp += 3 )
	{
		REGISTER oski_value_t _x0;
		REGISTER oski_value_t _x1;
		REGISTER oski_value_t _x2;
		...
		VAL_MAC( _y1, bdiag[3], _x0 );
		VAL_MAC( _y2, bdiag[6], _x0 );
		VAL_MAC( _y0, bdiag[1], _x1 );
		VAL_MAC( _y1, bdiag[4], _x1 );
		VAL_MAC( _y2, bdiag[7], _x1 );
		VAL_MAC( _y0, bdiag[2], _x2 );
		VAL_MAC( _y1, bdiag[5], _x2 );
		VAL_MAC( _y2, bdiag[8], _x2 );
		VAL_MAC( yp[0], alpha, _y0 );
		VAL_MAC( yp[1], alpha, _y1 );
		VAL_MAC( yp[2], alpha, _y2 );
	}
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX_3x6)
#endif
	...
	oski_value_t* restrict y, oski_index_t incy )
{
	...
	yp = y + d0*incy;
	xp = x + d0;
	for( I = 0; I < M; I++, bdiag += 3*3, yp += 3*incy, xp += 3 )
	{
		REGISTER oski_value_t _x0;
		REGISTER oski_value_t _x1;
		REGISTER oski_value_t _x2;
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1_3x6)
#endif
	...
	oski_value_t* restrict y )
{
	...
	yp = y + d0;
	xp = x + d0*incx;
	for( I = 0; I < M; I++, bdiag += 3*3, yp += 3, xp += 3*incx )
	{
		REGISTER oski_value_t _x0;
		REGISTER oski_value_t _x1;
		REGISTER oski_value_t _x2;
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX_3x6)
#endif
	...
	oski_value_t* restrict y, oski_index_t incy )
{
	...
	for( I = 0; I < M; I++, yp += 3*incy, xp += 3*incx )
	{
		REGISTER oski_value_t _y0;
		REGISTER oski_value_t _y1;
		REGISTER oski_value_t _y2;
	...
	yp = y + d0*incy;
	xp = x + d0*incx;
	for( I = 0; I < M; I++, bdiag += 3*3, yp += 3*incy, xp += 3*incx )
	{
		REGISTER oski_value_t _x0;
		REGISTER oski_value_t _x1;
		REGISTER oski_value_t _x2;
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1_3x6)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, bdiag += 3*3, yp += 3, xp += 3 )
	{
		...
		VAL_MAC_CONJ( _y1, bdiag[3], _x0 );
		VAL_MAC_CONJ( _y2, bdiag[6], _x0 );
		VAL_MAC_CONJ( _y0, bdiag[1], _x1 );
		VAL_MAC_CONJ( _y1, bdiag[4], _x1 );
		VAL_MAC_CONJ( _y2, bdiag[7], _x1 );
		VAL_MAC_CONJ( _y0, bdiag[2], _x2 );
		VAL_MAC_CONJ( _y1, bdiag[5], _x2 );
		VAL_MAC_CONJ( _y2, bdiag[8], _x2 );
		VAL_MAC( yp[0], alpha, _y0 );
		VAL_MAC( yp[1], alpha, _y1 );
		VAL_MAC( yp[2], alpha, _y2 );
	}
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX_3x6)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1_3x6)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX_3x6)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ys1_3x6)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ysX_3x6)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ys1_3x6)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ysX_3x6)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1_3x6)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX_3x6)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1_3x6)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX_3x6)
#endif
...
#define SymmSubmatReprMult MANGLE_MOD_(SymmSubmatReprMult_3x6)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 3x6 MBCSR format and
