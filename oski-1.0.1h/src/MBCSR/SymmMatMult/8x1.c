 ...
 *
 *  Automatically generated by ./gen_symm.sh on Wed Jun  8 16:00:30 PDT 2005.
 */
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ys1_8x1)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*1 )
		{
			...
			VAL_MAC( _yp0, bval[1], _x1 );
			VAL_MAC( _yp0, bval[2], _x2 );
			VAL_MAC( _yp0, bval[3], _x3 );
			VAL_MAC( _yp0, bval[4], _x4 );
			VAL_MAC( _yp0, bval[5], _x5 );
			VAL_MAC( _yp0, bval[6], _x6 );
			VAL_MAC( _yp0, bval[7], _x7 );
			VAL_MAC( _y0, bval[0], _xp0 );
			VAL_MAC( _y1, bval[1], _xp0 );
			VAL_MAC( _y2, bval[2], _xp0 );
			VAL_MAC( _y3, bval[3], _xp0 );
			VAL_MAC( _y4, bval[4], _xp0 );
			VAL_MAC( _y5, bval[5], _xp0 );
			VAL_MAC( _y6, bval[6], _xp0 );
			VAL_MAC( _y7, bval[7], _xp0 );
			VAL_INC( ypp[0], _yp0 );
		}
...
#define MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xs1_ysX_8x1)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ys1_8x1)
#endif
...
#define MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatMult_v1_aX_b1_xsX_ysX_8x1)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ys1_8x1)
#endif
	...
	oski_value_t* restrict y )
{
	...
	for( I = 0; I < M; I++, yp += 8, xp += 8 )
	{
		...
		for( K = bptr[I]; K < bptr[I+1]; K++, bind++, bval += 8*1 )
		{
			...
			VAL_MAC_CONJ( _yp0, bval[1], _x1 );
			VAL_MAC_CONJ( _yp0, bval[2], _x2 );
			VAL_MAC_CONJ( _yp0, bval[3], _x3 );
			VAL_MAC_CONJ( _yp0, bval[4], _x4 );
			VAL_MAC_CONJ( _yp0, bval[5], _x5 );
			VAL_MAC_CONJ( _yp0, bval[6], _x6 );
			VAL_MAC_CONJ( _yp0, bval[7], _x7 );
			VAL_MAC_CONJ( _y0, bval[0], _xp0 );
			VAL_MAC_CONJ( _y1, bval[1], _xp0 );
			VAL_MAC_CONJ( _y2, bval[2], _xp0 );
			VAL_MAC_CONJ( _y3, bval[3], _xp0 );
			VAL_MAC_CONJ( _y4, bval[4], _xp0 );
			VAL_MAC_CONJ( _y5, bval[5], _xp0 );
			VAL_MAC_CONJ( _y6, bval[6], _xp0 );
			VAL_MAC_CONJ( _y7, bval[7], _xp0 );
			VAL_INC( ypp[0], _yp0 );
		}
		VAL_MAC( yp[0], alpha, _y0 );
		VAL_MAC( yp[1], alpha, _y1 );
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xs1_ysX_8x1)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ys1_8x1)
#endif
...
#define MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_SymmMatConjMult_v1_aX_b1_xsX_ysX_8x1)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ys1_8x1)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xs1_ysX_8x1)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ys1_8x1)
#endif
...
#define MBCSR_HermMatMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatMult_v1_aX_b1_xsX_ysX_8x1)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ys1_8x1)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xs1_ysX_8x1)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1 MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ys1_8x1)
#endif
...
#define MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX MANGLE_MOD_(MBCSR_HermMatConjMult_v1_aX_b1_xsX_ysX_8x1)
#endif
...
#define SymmSubmatReprMult MANGLE_MOD_(SymmSubmatReprMult_8x1)
#endif

/**
 *  \brief Computes
 *  \f$y \leftarrow y + \alpha\cdot\mathrm{op}(A)\cdot x\f$,
 *  where \f$A\f$ is stored in 8x1 MBCSR format and
