/**
 *  \file src/MBCSR/MatTrisolve/3x6.c
 *  \brief The \f$3\times 6\f$ MBCSR implementation
 *  of sparse triangular solve.
 *  \ingroup MATTYPE_MBCSR
 *
 *  Automatically generated by ./gen_trisolve.sh
 *  on Wed Jun  8 16:02:53 PDT 2005.
 */
...
#include <oski/MBCSR/module.h>
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xs1_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 3, dp += 3*3 )
	{
		...
		VAL_DIVEQ( _b0, dp[0*3+0] );
		VAL_MSUB( _b1, dp[1*3+0], _b0 );
		VAL_MSUB( _b2, dp[2*3+0], _b0 );
		VAL_DIVEQ( _b1, dp[1*3+1] );
		VAL_MSUB( _b2, dp[2*3+1], _b1 );
		VAL_DIVEQ( _b2, dp[2*3+2] );
		VAL_ASSIGN( bp[0], _b0 );
		VAL_ASSIGN( bp[1], _b1 );
		VAL_ASSIGN( bp[2], _b2 );
	} /* I */
	...
	#define MBCSR_MatTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Lower_v1_aX_xsX_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x, oski_index_t incx )
{
	...
	for( I = 1; I != M+1; I++, bp += 3*incx, dp += 3*3 )
	{
		oski_index_t K;
		REGISTER oski_value_t _b0;
		REGISTER oski_value_t _b1;
...
/**
 *  \brief Exported module wrapper for the \f$3\times 6\f$
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xs1_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 3, dp += 3*3 )
	{
		...
		VAL_DIVEQ_CONJ( _b0, dp[0*3+0] );
		VAL_MSUB_CONJ( _b1, dp[1*3+0], _b0 );
		VAL_MSUB_CONJ( _b2, dp[2*3+0], _b0 );
		VAL_DIVEQ_CONJ( _b1, dp[1*3+1] );
		VAL_MSUB_CONJ( _b2, dp[2*3+1], _b1 );
		VAL_DIVEQ_CONJ( _b2, dp[2*3+2] );
		VAL_ASSIGN( bp[0], _b0 );
		VAL_ASSIGN( bp[1], _b1 );
		VAL_ASSIGN( bp[2], _b2 );
	} /* I */
	...
	#define MBCSR_MatConjTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Lower_v1_aX_xsX_3x6)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xs1_3x6)
#endif
...
{
	oski_index_t I;
	oski_value_t* bp = x + (d0 + (M-1)*3);
	const oski_value_t* dp = diag + (M-1)*3*3;
	...
	for( I = M; I != 0; I--, bp -= 3, dp -= 3*3 )
	{
		...
		VAL_DIVEQ( _b2, dp[2*3+2] );
		VAL_MSUB( _b0, dp[2*3+0], _b2 );
		VAL_MSUB( _b1, dp[2*3+1], _b2 );
		VAL_DIVEQ( _b1, dp[1*3+1] );
		VAL_MSUB( _b0, dp[1*3+0], _b1 );
		VAL_DIVEQ( _b0, dp[0*3+0] );
	...
	#define MBCSR_MatTransTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Lower_v1_aX_xsX_3x6)
#endif
...
{
	oski_index_t I;
	oski_value_t* bp = x + (d0 + (M-1)*3)*incx;
	const oski_value_t* dp = diag + (M-1)*3*3;
	...
	for( I = M; I != 0; I--, bp -= 3*incx, dp -= 3*3 )
	{
		oski_index_t K;
		REGISTER oski_value_t _b0;
		REGISTER oski_value_t _b1;
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xs1_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 3, dp -= 3*3 )
	{
		...
		VAL_DIVEQ_CONJ( _b2, dp[2*3+2] );
		VAL_MSUB_CONJ( _b0, dp[2*3+0], _b2 );
		VAL_MSUB_CONJ( _b1, dp[2*3+1], _b2 );
		VAL_DIVEQ_CONJ( _b1, dp[1*3+1] );
		VAL_MSUB_CONJ( _b0, dp[1*3+0], _b1 );
		VAL_DIVEQ_CONJ( _b0, dp[0*3+0] );
	...
	#define MBCSR_MatHermTrisolve_Lower_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Lower_v1_aX_xsX_3x6)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xs1_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 3, dp -= 3*3 )
	{
		...
		VAL_DIVEQ( _b2, dp[2*3+2] );
		VAL_MSUB( _b0, dp[0*3+2], _b2 );
		VAL_MSUB( _b1, dp[1*3+2], _b2 );
		VAL_DIVEQ( _b1, dp[1*3+1] );
		VAL_MSUB( _b0, dp[0*3+1], _b1 );
		VAL_DIVEQ( _b0, dp[0*3+0] );
		VAL_ASSIGN( bp[0], _b0 );
		VAL_ASSIGN( bp[1], _b1 );
		VAL_ASSIGN( bp[2], _b2 );
	...
	#define MBCSR_MatTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTrisolve_Upper_v1_aX_xsX_3x6)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xs1_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = M; I != 0; I--, bp -= 3, dp -= 3*3 )
	{
		...
		VAL_DIVEQ_CONJ( _b2, dp[2*3+2] );
		VAL_MSUB_CONJ( _b0, dp[0*3+2], _b2 );
		VAL_MSUB_CONJ( _b1, dp[1*3+2], _b2 );
		VAL_DIVEQ_CONJ( _b1, dp[1*3+1] );
		VAL_MSUB_CONJ( _b0, dp[0*3+1], _b1 );
		VAL_DIVEQ_CONJ( _b0, dp[0*3+0] );
		VAL_ASSIGN( bp[0], _b0 );
		VAL_ASSIGN( bp[1], _b1 );
		VAL_ASSIGN( bp[2], _b2 );
	...
	#define MBCSR_MatConjTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatConjTrisolve_Upper_v1_aX_xsX_3x6)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xs1_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 3, dp += 3*3 )
	{
		...
		VAL_DIVEQ( _b0, dp[0*3+0] );
		VAL_MSUB( _b1, dp[0*3+1], _b0 );
		VAL_MSUB( _b2, dp[0*3+2], _b0 );
		VAL_DIVEQ( _b1, dp[1*3+1] );
		VAL_MSUB( _b2, dp[1*3+2], _b1 );
		VAL_DIVEQ( _b2, dp[2*3+2] );
	...
	#define MBCSR_MatTransTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatTransTrisolve_Upper_v1_aX_xsX_3x6)
#endif
	...
	oski_value_t alpha, oski_vecview_t x )
{
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xs1 \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xs1_3x6)
#endif
	...
	oski_value_t alpha, oski_value_t* restrict x )
{
	...
	for( I = 1; I != M+1; I++, bp += 3, dp += 3*3 )
	{
		...
		VAL_DIVEQ_CONJ( _b0, dp[0*3+0] );
		VAL_MSUB_CONJ( _b1, dp[0*3+1], _b0 );
		VAL_MSUB_CONJ( _b2, dp[0*3+2], _b0 );
		VAL_DIVEQ_CONJ( _b1, dp[1*3+1] );
		VAL_MSUB_CONJ( _b2, dp[1*3+2], _b1 );
		VAL_DIVEQ_CONJ( _b2, dp[2*3+2] );
	...
	#define MBCSR_MatHermTrisolve_Upper_v1_aX_xsX \
		MANGLE_MOD_(MBCSR_MatHermTrisolve_Upper_v1_aX_xsX_3x6)
#endif
...
#define SubmatReprTrisolve MANGLE_MOD_(SubmatReprTrisolve_3x6)
#endif

/**
 *  \brief Entry point to the 3x6 kernel that implements
